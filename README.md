# rovast Awesome List [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)
...
* [pengx17/logseq-plugin-bullet-threading](https://github.com/pengx17/logseq-plugin-bullet-threading) - Add bullet threading to your active blocks in Logseq.
...
* [buka-ltd/oss.opendoc](https://github.com/buka-ltd/oss.opendoc) - \[WIP]支持OpenAPI/AsyncAPI的接口文档平台
...
* [netease-kit/nim-uikit-web](https://github.com/netease-kit/nim-uikit-web) - 网易云信即时通讯界面组件（简称 IM UIKit）是基于 NIM SDK（网易云信 IM SDK） 开发的一款即时通讯 UI 组件库，包括聊天、会话、圈组、搜索、通讯录、群管理等组件。通过 IM UIKit，您可快速集成包含 UI 界面的即时通讯应用。
...
* [machinefi-org/w3bstream-studio](https://github.com/machinefi-org/w3bstream-studio) - W3bstream development and node management GUI
...
* [lizhiyao/sentry-miniapp](https://github.com/lizhiyao/sentry-miniapp) - Mini Program Monitoring SDK (Error & Performance) for WeChat, Alipay, ByteDance, Baidu, QQ, DingTalk, Kuaishou & Taro / uni-app | 小程序监控 SDK（异常监控 + 性能监控），支持多端小程序及跨端框架
...
* [mayocream/mayo.sh](https://github.com/mayocream/mayo.sh) - curl -L mayo.sh | sh
...
* [nanqinlang-script/testrace](https://github.com/nanqinlang-script/testrace) - convenient to test your traceroute
...
* [soongo/path-to-regexp](https://github.com/soongo/path-to-regexp) - Turn a path string such as `/user/:name` into a regular expression
...
* [stc-community/nin](https://github.com/stc-community/nin) - Nin is a client framework for nostr-relayer
...
* [stc-community/stc-dpki](https://github.com/stc-community/stc-dpki) - Decentralized PKI infrastructure to increase application trust.
* [jordan-rash/wasmcloud-go](https://github.com/jordan-rash/wasmcloud-go) -
* [Taction/wasmcloud-http-provider-go](https://github.com/Taction/wasmcloud-http-provider-go) - wasmcloud http provider in go
...
* [FlowShield/FlowShield-fyne-gui](https://github.com/FlowShield/FlowShield-fyne-gui) - FlowShield-fyne-gui
...
* [klzgrad/forwardproxy](https://github.com/klzgrad/forwardproxy) - Forward proxy plugin for the Caddy web server
...
* [nats-io/nats-architecture-and-design](https://github.com/nats-io/nats-architecture-and-design) - Architecture and Design Docs
...
* [nisainan/wstunnel](https://github.com/nisainan/wstunnel) - A proxy based on native ws protocal.
...
* [go-chassis/kie-client](https://github.com/go-chassis/kie-client) - Go client of https://github.com/apache/servicecomb-kie
...
* [mayocream/chaos-mesh-controlpanel-demo](https://github.com/mayocream/chaos-mesh-controlpanel-demo) - 💣 Chaos Mesh Control Panel demo
...
* [gaochao1/swcollector](https://github.com/gaochao1/swcollector) -
...
* [Waitfantasy/unicorn](https://github.com/Waitfantasy/unicorn) -
...
* [prometheus/client\_js](https://github.com/prometheus/client_js) - Prometheus client for node.js
...
* [tangcent/easy-api](https://github.com/tangcent/easy-api) - IntelliJ plugin that generates API documentation and runnable requests from Java/Kotlin code, with export to Postman, Markdown,   cURL, and HTTP Client.
...
* [HeroCloudy/yyg-demo-ui](https://github.com/HeroCloudy/yyg-demo-ui) -
...
* [adler0518/github\_client\_flutter\_app](https://github.com/adler0518/github_client_flutter_app) - Flutter demo - GitHub client
...
* [yikeio/server](https://github.com/yikeio/server) - https://yike.io 服务端源码，项目基于 Laravel 10 开发。
...
* [overtrue/php-opencc](https://github.com/overtrue/php-opencc) - 中文简繁转换，支持词汇级别的转换、异体字转换和地区习惯用词转换（中国大陆、台湾、香港、日本新字体）。
...
* [basis-company/nats.php](https://github.com/basis-company/nats.php) - nats jetstream client for php
* [feiffy/codeIgnitor-ide-helper](https://github.com/feiffy/codeIgnitor-ide-helper) - codeignitor ide helper
...
* [contributte/nusoap](https://github.com/contributte/nusoap) - :smirk: Fixed NuSOAP for PHP 5.6 - 8.5
...
* [dmstr/yii2-adminlte-asset](https://github.com/dmstr/yii2-adminlte-asset) - AdminLTE Asset Bundle for Backend Theme in Yii2 Framework

## Jupyter Notebook

* [keitazoumana/Medium-Articles-Notebooks](https://github.com/keitazoumana/Medium-Articles-Notebooks) -
...
* [caffeinelabs/motoko](https://github.com/caffeinelabs/motoko) - Simple high-level language for writing Internet Computer canisters
...
* [shivammathur/homebrew-extensions](https://github.com/shivammathur/homebrew-extensions) - Homebrew tap for PHP extensions :beers:
...
* [kissgyorgy/redbean-docker](https://github.com/kissgyorgy/redbean-docker) - Docker image for redbean from the "scratch" container
